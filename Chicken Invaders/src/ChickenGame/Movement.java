 ...
 * @author ASUS
 */
public class Movement extends JPanel implements Runnable{
           ...
           if(egg.y == 600)
           {
             ...
             eggs.add(new EGGClass(450,0,5,5));
               ...
               egg.egg.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\Shehab\\Documents\\NetBeansProjects\\ball.png").getImage().getScaledInstance(200,157, Image.SCALE_DEFAULT)));
                ...
                {
                    JOptionPane.showMessageDialog(null,"You lost. " +"High Score: " + cnt, " Game Over.",JOptionPane.ERROR_MESSAGE);
                    setVisible(false);
                    System.exit(1);
                    break;
            }
...
//            Balls.add(new Chickens(0,0,15,Color.red));
            ...
            if(OneBall.x == 400)
            {
                ...
                if(Balls.size() == 15)
                {
                    Balls.add(new Chickens(0,190,15,Color.red));
                }
            }
...
//            }
    ...
    while(true)
    {
        if(Balls.isEmpty())
        {
          JOptionPane.showMessageDialog(null,"Player Wins! High Score: "+cnt);
          Start st = new Start();
          st.setVisible(true);
